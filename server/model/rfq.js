...
const claimModel = mongoose.model('RFQ', rfqSchema);


const getRFQDB = async (tenantId) => {
...
const getRFQModel = async (tenantId) => {
  const tenantDb = await getRFQDB(tenantId);
  return tenantDb.model("RFQ", rfqSchema);
};

module.exports = getRFQModel;